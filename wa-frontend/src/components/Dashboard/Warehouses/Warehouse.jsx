    ...
    return (
        <div >
            <div>
                ...
                {
                    loggedInUser.roleId === 2 && <Button variant="outlined" onClick={handleButtonClick}>
                        Edit
                    </Button>
                }
            </div>
            ...
            <Grid container spacing={2}>
                    <Grid item xs={12}>
                        <h2> Items: </h2>
                        {
                            loggedInUser.username === managerName && <Button sx={{ borderRadius: 8 }} variant="outlined" onClick={handleItemAddButtonClick}>
                                +
                            </Button> 
                        }
                    </Grid>
                        ...
                        return <Grid item xs={4} key={i} style={{ textDecoration: 'none' }}>
                            ...
                            >
                                <div style={{ padding: '50px' }}>
                                    ...
                                    { loggedInUser.username === managerName && <span><Button style={{backgroundColor: 'red', color: "white"}} onClick={(e) => handleDeleteItem(e, warehouseItem.id)}>Delete</Button></span> }
                                    { loggedInUser.username === managerName && <span><Button style={{backgroundColor: 'blue', color: "white", marginLeft: "10px"}} onClick={() => handleSellItems(warehouseItem)}>Sell</Button></span> }
                                </div>
                            </Paper>
